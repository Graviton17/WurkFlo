      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-8 max-w-xl">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-500/10 text-indigo-400 text-sm font-semibold w-fit border border-indigo-500/20 shadow-[0_0_15px_rgba(99,102,241,0.1)]">
              <Zap className="w-4 h-4" />
              <span className="tracking-wide">Experience The Aha Moment</span>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg md:text-xl text-zinc-400 leading-relaxed font-medium mt-2">
                Play around with our interactive components right here. Discover the blazing fast workflow that developers love.
              </p>
            </div>
            
            <div className="pt-2 flex flex-col gap-6">
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-zinc-900/50 border border-zinc-800/80 hover:border-indigo-500/30 transition-colors group">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="text-sm text-zinc-500">Pick up a sprint card and move it across columns to see the satisfying, physics-based interactions.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-zinc-900/50 border border-zinc-800/80 hover:border-indigo-500/30 transition-colors group">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="text-sm text-zinc-500">Trigger the global command palette from anywhere. It's the fastest way to navigate and take action.</p>
                </div>
              </div>
            </div>
          </div>

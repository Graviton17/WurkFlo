...
export function TeamList({ members }: { members: any[] }) {
  if (!members || members.length === 0) {
    return (
      <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="w-full max-w-2xl mx-auto px-6 py-16">
          ...
          >
            <div className="flex items-center space-x-4">
              <Avatar className="border border-white/10">
                ...
                <AvatarFallback className="bg-[#111] border border-white/20 text-white/70">
